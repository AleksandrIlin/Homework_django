...
urlpatterns = [
    ...
    path('category/<str:category_name>/', CatalogProductByCategoryView.as_view(), name='category_products'),
    path('product/<int:pk>/', cache_page(60)(CatalogProductDetailView.as_view()), name='product_detail'),
